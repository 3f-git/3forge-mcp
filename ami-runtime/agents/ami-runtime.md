...
**Layout delegation is non-negotiable.** You must use the Agent tool to invoke `ami-layout-architect`. If you find yourself reading layout knowledge files, stop immediately and spawn the sub-agent instead.
