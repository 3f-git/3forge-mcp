...
1. **Discover tools** with ToolSearch (the `3forge-runtime` tools are deferred). Search by subdomain or verb, e.g. `select:ami_console,web_console` or a keyword like `center execute`.
